...
function updateAvailableBalance() {
    alert("In the updateAvailableBalance() function.");
...
function populateEmployeeData(res) {
    ...
    nameTag.innerHTML += res;

    for(let i = 0; i < res.length; i++) {
        let lineBreak = document.createElement("br");

        console.log("res[i].lastName = " + res[i].lastName);

        nameTag.innerHTML += " <b>" + res[i].firstName +"</b>";
        nameTag.innerHTML += " <b>" + res[i].lastName + "</b>";
        nameTag.innerHTML += " <b>" + res[i].employeeId + "</b>";
