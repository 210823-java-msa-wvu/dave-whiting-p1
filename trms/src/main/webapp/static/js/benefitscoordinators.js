...
async function getPendingReimbursementsFetch() {
    alert("In the getAllPendingReimbursementsFetch() function.");
...
async function getDirectSupervisorAndDepartmentHeadApprovedPendingReimbursementsFetch() {
    alert("In the getDirectSupervisorAndDepartmentHeadApprovedPendingReimbursementsFetch() function.");
...
function awardReimbursement() {
    alert("In the awardReimbursement() function in benco js.");
...
function adjustAmount() {
    alert("In the adjustAmount() function in benco js.");
