...
async function getDirectSupervisorApprovedPendingReimbursementsFetch() {
    alert("In the getDirectSupervisorApprovedPendingReimbursementsFetch() function.");

    let url = 'http://localhost:8080/trms/reimbursements/f';
...
function approveReimbursement() {
    alert("In the approveReimbursement() function.");
    let reimbursement_id = document.getElementById('reimbursementId3').value;
    let is_department_head_approved = true;

        let data = {
                    reimbursementId: reimbursement_id,
                    isDepartmentHeadApproved: is_department_head_approved
            }
        ...
        let xhttp = new XMLHttpRequest();
            ...
            xhttp.open('PUT', 'http://localhost:8080/trms/reimbursements/h', true);
...
function declineReimbursement() {
    alert("In the declineReimbursement() in departmentheads.js function.");
...
function requestAdditionalInfo() {
    alert("In the requestAdditionalInfo() function.");
