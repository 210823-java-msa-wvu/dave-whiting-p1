    ...
    public void process(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (path == null || path.equals("")) { // http://localhost:8080/trms/reimbursements
            ...
            switch (request.getMethod()) {
                ...
                && !p.equals("p") && !p.equals("r") && !p.equals("s")) {
            ...
            switch (request.getMethod()) {
                ...
                case "PUT": {
                    System.out.println("Updating a reimbursement in the database...");
                ...
                case "DELETE": {
                    System.out.println("Deleting a reimbursement");
            ...
            switch (p) {
                ...
                case "d": {
                    System.out.println("/d Decline A Reimbursement");
                    Reimbursement r;
                    r = om.readValue(request.getReader(), Reimbursement.class);
                ...
                case "f": {
                    System.out.println("/f Get Direct Supervisor Approved Pending Reimbursements");
